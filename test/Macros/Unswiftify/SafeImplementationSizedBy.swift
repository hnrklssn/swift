...
//   expected-remark@2{{macro content: |@_alwaysEmitIntoClient @_disfavoredOverload public func compound(_ p: UnsafeMutableRawBufferPointer, _ size: Int32, _ len: Int32) {|}}
...
//   expected-remark@1{{macro content: |/// This is an auto-generated wrapper for safer interop|}}
//   expected-remark@2{{macro content: |@_alwaysEmitIntoClient @_disfavoredOverload public func compound_half_shared(_ p1: UnsafeMutableRawBufferPointer, _ size: Int32, _ p2: UnsafeMutableBufferPointer<Int32>) {|}}
...
//   expected-remark@1{{macro content: |/// This is an auto-generated wrapper for safer interop|}}
//   expected-remark@2{{macro content: |@_alwaysEmitIntoClient @_disfavoredOverload public func neg(_ p: UnsafeMutableRawBufferPointer, _ size: Int32) {|}}
...
//   expected-remark@1{{macro content: |/// This is an auto-generated wrapper for safer interop|}}
//   expected-remark@2{{macro content: |@_alwaysEmitIntoClient @_disfavoredOverload public func neg_mismatch(_ p: UnsafeMutableRawBufferPointer, _ size: Int32) {|}}
//   expected-remark@3{{macro content: |    if p.count != -size {|}}
...
//   expected-remark@2{{macro content: |public func compound(_ p: UnsafeMutableRawPointer?, _ size: Int32, _ len: Int32) {|}}
...
//   expected-remark@1{{macro content: |@c @implementation|}}
//   expected-remark@2{{macro content: |public func compound_half_shared(_ p1: UnsafeMutableRawPointer?, _ size: Int32, _ len: Int32, _ p2: UnsafeMutablePointer<Int32>?) {|}}
...
// expected-expansion@+7:2{{
//   expected-remark@1{{macro content: |@c @implementation|}}
//   expected-remark@2{{macro content: |public func neg(_ p: UnsafeMutableRawPointer?, _ size: Int32) {|}}
