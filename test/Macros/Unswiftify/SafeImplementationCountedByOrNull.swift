...
//   expected-remark@2{{macro content: |public func ubp_ornull_default(_ x: UnsafePointer<Int32>?, _ len: Int32) {|}}
...
// expected-expansion@+7:2{{
//   expected-remark@1{{macro content: |@c @implementation|}}
//   expected-remark@2{{macro content: |public func ubp_ornull_nullable(_ x: UnsafePointer<Int32>?, _ len: Int32) {|}}
...
// expected-expansion@+7:2{{
//   expected-remark@1{{macro content: |@c @implementation|}}
//   expected-remark@2{{macro content: |public func ubp_ornull_nonnull(_ x: UnsafePointer<Int32>, _ len: Int32) {|}}
//   expected-remark@3{{macro content: |    let _ptr0 = UnsafeBufferPointer(start: x, count: Int(len))|}}
...
// expected-expansion@+7:2{{
//   expected-remark@1{{macro content: |@c @implementation|}}
//   expected-remark@2{{macro content: |public func span_ornull_default(_ x: UnsafePointer<Int32>?, _ len: Int32) {|}}
//   expected-remark@3{{macro content: |    let _ptr0 = if x != nil { Span(_unsafeStart: x!, count: Int(len)) } else { Span<Int32>() }|}}
...
// expected-expansion@+7:2{{
//   expected-remark@1{{macro content: |@c @implementation|}}
//   expected-remark@2{{macro content: |public func span_ornull_nullable(_ x: UnsafePointer<Int32>?, _ len: Int32) {|}}
...
// expected-expansion@+7:2{{
//   expected-remark@1{{macro content: |@c @implementation|}}
//   expected-remark@2{{macro content: |public func span_ornull_nonnull(_ x: UnsafePointer<Int32>, _ len: Int32) {|}}
