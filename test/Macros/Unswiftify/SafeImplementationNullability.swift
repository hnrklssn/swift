...
//   expected-remark@2{{macro content: |public func ubp_default(_ x: UnsafePointer<Int32>?, _ len: Int32) {|}}
...
// expected-expansion@+7:2{{
//   expected-remark@1{{macro content: |@c @implementation|}}
//   expected-remark@2{{macro content: |public func ubp_nonnull(_ x: UnsafePointer<Int32>, _ len: Int32) {|}}
//   expected-remark@3{{macro content: |    let _ptr0 = UnsafeBufferPointer(start: x, count: Int(len))|}}
...
// expected-expansion@+7:2{{
//   expected-remark@1{{macro content: |@c @implementation|}}
//   expected-remark@2{{macro content: |public func ubp_nullable(_ x: UnsafePointer<Int32>?, _ len: Int32) {|}}
...
// expected-expansion@+7:2{{
//   expected-remark@1{{macro content: |@c @implementation|}}
//   expected-remark@2{{macro content: |public func span_default(_ x: UnsafePointer<Int32>?, _ len: Int32) {|}}
...
// expected-expansion@+7:2{{
//   expected-remark@1{{macro content: |@c @implementation|}}
//   expected-remark@2{{macro content: |public func span_nonnull(_ x: UnsafePointer<Int32>, _ len: Int32) {|}}
...
// expected-expansion@+7:2{{
//   expected-remark@1{{macro content: |@c @implementation|}}
//   expected-remark@2{{macro content: |public func span_nullable(_ x: UnsafePointer<Int32>?, _ len: Int32) {|}}
