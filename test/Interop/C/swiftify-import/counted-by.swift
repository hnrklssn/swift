...
// CECK-NEXT: @_alwaysEmitIntoClient public func returnPointer(_  len: Int{{.*}}) -> UnsafeMutableBufferPointer<Int{{.*}}>?
// CHECK-NEXT: @_alwaysEmitIntoClient public func returnPointer(_ len: Int32) -> UnsafeMutableBufferPointer<Int32>
